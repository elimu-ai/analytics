...
object CursorToLetterSoundAssessmentEventGsonConverter {
    ...
    fun getLetterSoundAssessmentEventGson(cursor: Cursor): LetterSoundAssessmentEventGson {
        ...
        val columnMasteryScore: Int = cursor.getColumnIndexOrThrow(BUNDLE_KEY_MASTERY_SCORE)
        ...
        val columnTimeSpentMs: Int = cursor.getColumnIndexOrThrow(BUNDLE_KEY_TIME_SPENT_MS)
        ...
        val columnLetterSoundLetters: Int = cursor.getColumnIndex(BUNDLE_KEY_LETTER_SOUND_LETTERS)
        ...
        val columnLetterSoundSounds: Int = cursor.getColumnIndex(BUNDLE_KEY_LETTER_SOUND_SOUNDS)
        ...
        val columnLetterSoundId: Int = cursor.getColumnIndex(BUNDLE_KEY_LETTER_SOUND_ID)
