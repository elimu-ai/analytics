...
public class ShapeLearningEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // Store in log file
        // Expected format: id:1|deviceId:4113947bec18b7ad|time:1481916197273|packageName:org.literacyapp|studentId:4113947bec18b7ad_1|shape:CIRCLE
        ...
        String logsPath = Environment.getExternalStorageDirectory() + "/.literacyapp-analytics/events/device_" + shapeLearningEvent.getDeviceId();
