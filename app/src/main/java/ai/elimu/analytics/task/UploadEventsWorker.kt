...
class UploadEventsWorker(context: Context, workerParams: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        uploadLearningEvents(EventType.LETTER_SOUND_ASSESSMENT)

        uploadLearningEvents(EventType.WORD_LEARNING)
        uploadLearningEvents(EventType.WORD_ASSESSMENT)

        uploadLearningEvents(EventType.NUMBER_LEARNING)
